                    ...
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu custom-dropdown">
                                <li><a class="dropdown-item" href="../HomeLoan/HomeLoan.jsp">Home Loan</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div
                        ...
                        <h1 id="banner-long-title" class="primary-text-color font-weight-bold text-uppercase">Vehicle
                            Loans</h1>
                        <p class="mb-lg-5 mb-sm-3 text-justify">Products that help you to drive home your dream car</p>
                    </div>
                    <div class="col-lg-8 order-1 order-sm-1 order-md-1 order-lg-2 pr-0 pr-mob-grid">
                        <picture data-fileentryid="24947718">
                            ...
                            <picture data-fileentryid="24947718">
                                ...
                                <source media="(max-width:1000px) and (min-width:300px)"
                                    srcset="/o/adaptive-media/image/24947718/Preview-1000x0/home-loans.webp?t=1723780756410">
                                <img class="img-fluid boder-img product-detail-banner" alt="Vehicle Loans"
                                    title="Vehicle Loans" data-fileentryid="24947718"
                                    src="https://bankofindia.co.in/documents/20121/24950596/vehicle-loan.webp/09e8584b-8c74-bdfd-447a-010fa209e4ba?t=1723781698700">
                            </picture>
                        </picture>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 px-0 px-mob-grid">
                        <h2 class="heading mt-1 mt-md-0 mb-4">BENEFITS OF VEHICLE LOANS</h2>
                    </div>
                </div>
            </div>
        </section>
                                                    ...
                                                    <div>
                                                        <picture data-fileentryid="137118">
                                                            ...
                                                            <picture data-fileentryid="137118">
                                                                ...
                                                                <source media="(max-width:36px) and (min-width:36px)"
                                                                    srcset="/o/adaptive-media/image/137118/Thumbnail-300x300/Iconawesome-percentage.png?t=1662115680476">
                                                                <img alt="Low Interest Rates" data-fileentryid="137118"
                                                                    src="https://bankofindia.co.in/documents/20121/135546/Iconawesome-percentage.png/926cc2f9-0fff-1f4c-b153-15aa7ecd461d?t=1662115680476"
                                                    ...
                                                    <div>
                                                        <picture data-fileentryid="137126">
                                                            ...
                                                            <picture data-fileentryid="137126">
                                                                ...
                                                                <source media="(max-width:27px) and (min-width:27px)"
                                                                    srcset="/o/adaptive-media/image/137126/Thumbnail-300x300/Iconawesome-rupee-sign.png?t=1662115680481">
                                                                <img alt="No Hidden Charges" data-fileentryid="137126"
                                                                    src="https://bankofindia.co.in/documents/20121/135546/Iconawesome-rupee-sign.png/60c05e46-0b47-e550-1c56-76dcaa78697e?t=1662115680481"
                                                                    class="new-enh-cardicon">
                                                            </picture>
                                                        </picture>
                                                    </div>
                                                    ...
                                                    <div>
                                                        <picture data-fileentryid="137134">
                                                            ...
                                                            <picture data-fileentryid="137134">
                                                                ...
                                                                <source media="(max-width:29px) and (min-width:29px)"
                                                                    srcset="/o/adaptive-media/image/137134/Thumbnail-300x300/Iconionic-md-document.png?t=1662115680485">
                                                                <img alt="Minimal Documentation"
                                                                    data-fileentryid="137134"
                                                                    src="https://bankofindia.co.in/documents/20121/135546/Iconionic-md-document.png/8158f399-4c2a-d105-a423-a3370ffa1a96?t=1662115680485"
                                                                    class="new-enh-cardicon">
                                                            </picture>
                                                        </picture>
                                                    </div>
                                                    ...
                                                    <div>
                                                        <picture data-fileentryid="137110">
                                                            ...
                                                            <picture data-fileentryid="137110">
                                                                ...
                                                                <source media="(max-width:32px) and (min-width:32px)"
                                                                    srcset="/o/adaptive-media/image/137110/Thumbnail-300x300/Iconawesome-hand-pointer.png?t=1662115680472">
                                                                <img alt="Apply Online" data-fileentryid="137110"
                                                                    src="https://bankofindia.co.in/documents/20121/135546/Iconawesome-hand-pointer.png/df93865b-adf0-f170-a712-14e30caaa425?t=1662115680472"
                                                                    class="new-enh-cardicon">
                                                            </picture>
                                                        </picture>
                                                    </div>
                ...
                <div
                    ...
                    <div class="col-auto d-none d-lg-block">
                        ...
                        <img src="https://bankofindia.co.in/documents/20121/24950596/star-vehicle-loan-individual.webp/7ec12441-c02a-e0e2-63bd-804bae7b36e0?t=1723781746598"
                            width="300" height="250" alt="star personal loan">
                    </div>
                    <div class="col p-4 d-flex flex-column position-static">
                        <h3 class="mb-0">Star Vehicle Loan - Individuals</h3>
                        <div class="mb-1 text-body-secondary">jan 10</div>
                        <p class="card-text mb-auto">To avail loan for your dream vehicle</p>
                ...
                <div
                    ...
                    <div class="col-auto d-none d-lg-block">
                        <img src="https://bankofindia.co.in/documents/20121/24950596/star-vehicle-loan-other-than-individual.webp/a65e256c-ff01-72f9-302e-f02707b4f2f9?t=1723781766093"
                            width="300" height="250" alt="star pensioner Loan">
                    </div>
                    <div class="col p-4 d-flex flex-column position-static">
                        <h3 class="mb-0">Star Vehicle Loan - Entities other than...</h3>
                        <div class="mb-1 text-body-secondary">Jun 20</div>
                        <p class="card-text mb-auto">Vehicle loan for other than individuals</p>
                ...
                <div
                    ...
                    <div class="col-auto d-none d-lg-block">
                        <img src="https://bankofindia.co.in/documents/20121/24950596/star-vehicle-loan-doctor-plus.webp/d1dc5583-411d-ad28-bf2e-249ccfb1df2a?t=1723781787561"
                            width="300" height="250" alt="Star Suvidha Express Personal Loan">
                    </div>
                    <div class="col p-4 d-flex flex-column position-static">
                        <h3 class="mb-0">Star Vehicle Loan - Doctor Plus</h3>
                        <div class="mb-1 text-body-secondary">Feb 12</div>
                        <p class="card-text mb-auto">RGSDSA Star Vehicle loan scheme - doctor plus</p>
