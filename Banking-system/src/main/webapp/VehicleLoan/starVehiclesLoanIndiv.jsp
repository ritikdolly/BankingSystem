							...
							<ul class="dropdown-menu custom-dropdown">
								<li><a class="dropdown-item"
									href="starVehicleLoanDoctorPlus.jsp">Vehicle Loan-Doctor
										Plus</a></li>
								<li><a class="dropdown-item"
									href="starVehicleEnitiesLoan.jsp">Vehicle Loan- Entities
										... </a></li>
							</ul></li>
			...
			<div class="tab-content" id="myTabContent">
						...
						<div class="card border-0">
							<div class="card-body pb-0 pt-0 px-0">
								<h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">Star
									Vehicle Loan - Individuals - FEATURES</h4>
								...
								<div class="col-md-12 my-3">
									...
									<ul class="pl-3 normal-text my-3 List-eligiblity">
										<li class="my-2"><b>Maximum repayment tenure :</b><br>Two
											wheelers: up to 60 months.<br>Four wheelers / Water
											Vehicle - Max. 84 months.</li>
										<li class="my-2">Second hand 2 and 4 wheeler — Age of the
											vehicle not to exceed 3 years</li>
										<li class="my-2">Maximum quantum up to 90% for
											Individuals including NRIs (For New vehicles only and 70% for
											Old Vehicles.</li>
										<li class="my-2">No third party guarantee required (up to
											limit Rs. 50.00 Lakh)</li>
								...
								<div class="col-md-12 my-3">
									...
									<ul class="pl-3 normal-text my-3 List-eligiblity">
										...
										<li class="my-2">Special Scheme for Tata Motors Personal
											Vehicles</li>
									</ul>
								</div>
							</div>
				...
				<div class="tab-pane fade" id="Eligibility-tab-pane" role="tabpanel"
					...
					<div class="col-12">
						<div class="card border-0">
							<div class="card-body pb-0 pt-0 px-0">
								<h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">Star
									Vehicle Loan - Individuals - ELIGIBILITY</h4>
								<hr class="selectedtabhr" style="display: block;">
								<div class="col-md-12 my-3">
									<h5 class="tab-contet-botom-headin"></h5>
									<ul class="pl-3 normal-text my-3 List-eligiblity">
										...
										<li class="my-2">For entities other than individuals 4
											times of average annual cash accrual (i.e. PAT +
											Depreciation) as per last two years I.T. Returns, Audited
											balance sheet, P&amp;L Account filed in respective assessment
											years subject to a minimum DSCR of 1.25</li>
										<li class="my-2">Directors of private and public limited
											companies, proprietor of proprietorship firms, partners of
											partnership firms.</li>
										<li class="my-2">NRIs/PIOs</li>
										<li class="my-2">Age: Minimum 18 years to maximum age 65
											years (Entry Age)</li>
									</ul>
								</div>
							</div>
				...
				<div class="tab-pane fade" id="interest-tab-pane" role="tabpanel"
					...
					<div class="col-12">
						<div class="card border-0">
							<div class="card-body pb-0 pt-0 px-0">
								<h2 class="tabheadingmand tabseo tab-contet-botom-headin my-3">Star
									Vehicle Loan - Individuals - RATE OF INTEREST &amp; CHARGES</h2>
								<hr class="selectedtabhr" style="display: block;">
								<div class="col-md-12 my-3">
				...
				<div class="tab-pane fade" id="doc-tab-pane" role="tabpanel"
					...
					<div class="col-12">
						<div class="card border-0">
							<div class="card-body pb-0 pt-0 px-0">
								<h2 class="tabheadingmand tabseo tab-contet-botom-headin my-3">Star
									Vehicle Loan - Individuals - DOCUMENTS</h2>
								<hr class="selectedtabhr" style="display: block;">
								<div class="col-md-12 my-3">
								...
								<div class="col-md-12 my-3">
									<h3 class="tab-contet-botom-headin"></h3>
									<p class="normal-text my-3 text-justify">PAN/ Aadhar
										Card/Passport/Driver Licence/Voter ID</p>
									<ul class="pl-3 normal-text my-3 List-eligiblity">
								...
								<div class="col-md-12 my-3">
									<h3 class="tab-contet-botom-headin"></h3>
									<p class="normal-text my-3 text-justify">Passport/Driver
										Licence/Aadhar Card/ Latest Electricity Bill/Latest Telephone
										Bill/Latest Piped gas bill/House tax receipt.</p>
									<ul class="pl-3 normal-text my-3 List-eligiblity">
								...
								<div class="col-md-12 my-3">
									<h3 class="tab-contet-botom-headin"></h3>
									<p class="normal-text my-3 text-justify">Latest 6 Month
										Salary/Pay Slip and two year ITR/Form16.</p>
									<ul class="pl-3 normal-text my-3 List-eligiblity">
								...
								<div class="col-md-12 my-3">
									<h3 class="tab-contet-botom-headin"></h3>
									<p class="normal-text my-3 text-justify">Last 3 years ITR
										with CA certified Computation of Income/Profit &amp; Loss
										Account/Balance Sheet/Capital Account Statement</p>
								</div>
								<div class="col-md-12 my-3">
									<h3 class="tab-contet-botom-headin">For other than
										Individuals</h3>
									<ul class="pl-3 normal-text my-3 List-eligiblity">
				...
				<div class="col mb-3">
					...
					<div class="card userCard" style="width: 18rem; height: 390px;">
						<img
							...
							class="card-img-top"
							alt="STAR VEHICLE LOAN - ENTITIES OTHER THAN INDIVIDUAL">
						<div class="card-body d-flex justify-content-between flex-column">
							<h5 class="card-title">STAR VEHICLE LOAN - ENTITIES OTHER
								THAN INDIVIDUAL</h5>
							<p class="card-text">RGSDSA Star Vehicle Loan scheme-
								Entities other than Individual</p>
							<a href="starVehicleEnitiesLoan.jsp"
