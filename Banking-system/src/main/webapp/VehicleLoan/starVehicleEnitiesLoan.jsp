...
<head>
    ...
    <title>STAR VEHICLE LOAN - ENTITIES OTHER THAN INDIVIDUAL |Features</title>
            ...
            <div class="container">
                <div class="row">
                    <div
                        ...
                        <h1 id="banner-long-title" style="font-size: 45px;" class=" font-weight-bold text-uppercase">STAR VEHICLE LOAN - ENTITIES OTHER THAN INDIVIDUAL</h1>
                        <p>RGSDSA STAR VEHICLE LOAN SCHEME- ENTITIES OTHER THAN INDIVIDUALS</p>
                    </div>
            ...
            <div class="tab-content" id="myTabContent">
                    ...
                    <div class="col-12">
                        <div class="card border-0">
                         <div class="card-body pb-0 pt-0 px-0">
                          <h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">STAR VEHICLE LOAN - ENTITIES OTHER THAN INDIVIDUAL - FEATURES</h4>
                ...
                <div class="tab-pane fade" id="Eligibility-tab-pane" role="tabpanel" aria-labelledby="Eligibility-tab"
                    ...
                    <div class="col-12">
                        <div class="card border-0">
                         <div class="card-body pb-0 pt-0 px-0">
                          <h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">STAR VEHICLE LOAN - ENTITIES OTHER THAN INDIVIDUAL - ELIGIBILITY</h4>
                          <hr class="selectedtabhr" style="display: block;">
                          <div class="col-md-12 my-3">
                           <h5 class="tab-contet-botom-headin"></h5>
                           <ul class="pl-3 normal-text my-3 List-eligiblity">
                            <li class="my-2">Companies, Partnership firms, Proprietary concern and other types of corporate entities.</li>
                           </ul>
                          </div>
                         </div>
                        </div>
                ...
                <div class="tab-pane fade" id="interest-tab-pane" role="tabpanel" aria-labelledby="interest-tab"
                    ...
                    <div class="col-12">
                        <div class="card border-0">
                         <div class="card-body pb-0 pt-0 px-0">
                          <h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">STAR VEHICLE LOAN - ENTITIES OTHER THAN INDIVIDUAL - RATE OF INTEREST &amp; CHARGES</h4>
                          <hr class="selectedtabhr" style="display: block;">
                          <div class="col-md-12 my-3">
                           <h5 class="tab-contet-botom-headin">Rate of Interest</h5>
                           <ul class="pl-3 normal-text my-3 List-eligiblity">
                            <li class="my-2">Starting from 8.85%</li>
                            <li class="my-2">ROI is linked with CMR, Internal Or External Rating</li>
                ...
                <div class="tab-pane fade" id="doc-tab-pane" role="tabpanel" aria-labelledby="doc-tab" tabindex="0">
                    <div class="col-12">
                        <div class="card border-0">
                         <div class="card-body pb-0 pt-0 px-0">
                          <h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">STAR VEHICLE LOAN - ENTITIES OTHER THAN INDIVIDUAL - DOCUMENTS</h4>
                          <hr class="selectedtabhr" style="display: block;">
                          <div class="col-md-12 my-3">
