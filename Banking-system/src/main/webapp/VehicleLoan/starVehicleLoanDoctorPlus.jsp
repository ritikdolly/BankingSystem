						...
						<div class="card border-0">
							<div class="card-body pb-0 pt-0 px-0">
								<h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">STAR
									VEHICLE LOAN - DOCTOR PLUS - FEATURES</h4>
				...
				<div class="tab-pane fade" id="Eligibility-tab-pane" role="tabpanel"
					...
					<div class="col-12">
						<div class="card border-0">
							<div class="card-body pb-0 pt-0 px-0">
								<h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">STAR
									VEHICLE LOAN - DOCTOR PLUS - ELIGIBILITY</h4>
								<hr class="selectedtabhr" style="display: block;">
								<div class="col-md-12 my-3">
									<h5 class="tab-contet-botom-headin"></h5>
									<ul class="pl-3 normal-text my-3 List-eligiblity">
										<li class="my-2">Registered medical practitioner having 3
											years of experience with any Branch of medical science.
											(MBBS, BDS. BAMS, BHMS),</li>
									</ul>
								</div>
							</div>
						</div>
				...
				<div class="tab-pane fade" id="interest-tab-pane" role="tabpanel"
					...
					<div class="col-12">
						<div class="card border-0">
							<div class="card-body pb-0 pt-0 px-0">
								<h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">STAR
									VEHICLE LOAN - DOCTOR PLUS - RATE OF INTEREST &amp; CHARGES</h4>
								<hr class="selectedtabhr" style="display: block;">
								<div class="col-md-12 my-3">
									<h5 class="tab-contet-botom-headin"></h5>
									<ul class="pl-3 normal-text my-3 List-eligiblity">
				...
				<div class="tab-pane fade" id="doc-tab-pane" role="tabpanel"
					...
					<div class="col-12">
						<div class="card border-0">
							<div class="card-body pb-0 pt-0 px-0">
								<h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">STAR
									VEHICLE LOAN - DOCTOR PLUS - DOCUMENTS</h4>
								<hr class="selectedtabhr" style="display: block;">
								<div class="col-md-12 my-3">
									<h5 class="tab-contet-botom-headin"></h5>
									<ul class="pl-3 normal-text my-3 List-eligiblity">
										<li class="my-2">Proof of identity (any one): PAN/ Aadhar
											Card/Passport/Driver Licence/Voter ID</li>
										<li class="my-2">Proof of Address (any one):
											Passport/Driver Licence/Aadhar Card/ Latest Electricity
											Bill/Latest Telephone Bill/Latest Piped gas bill/House tax
											receipt.</li>
										<li class="my-2">Proof of Income (any one): For salaried:
											Latest 6 Month Salary/Pay Slip and two year ITR/Form16. For
											Self-employed: Last 3 years ITR with CA certified Computation
											of Income/Profit &amp; Loss Account/Balance Sheet/Capital
											Account Statement</li>
										<li class="my-2">Copy of registration with MCI/DCI/ other
											statutory / regulatory authorities to practice in India</li>
									</ul>
								</div>
							</div>
						</div>
