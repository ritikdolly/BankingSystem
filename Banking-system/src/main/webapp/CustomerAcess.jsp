          ...
          <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu custom-dropdown">
                ...
                <li><a class="dropdown-item" href="../transaction.jsp">Send Money</a></li>
                <li><a class="dropdown-item" href="../withdramMoney.jsp">Withdraw Money</a></li>
              </ul>
            </li>
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        ...
        <div class="carousel-caption d-none d-md-block opacity-75 bg-dark">
          ...
          <a class="btn btn-primary" href="../transaction.jsp"  role="button">Send Money</a>
        </div>
      </div>
      <div class="carousel-item">
        ...
        <div class="carousel-caption d-none d-md-block opacity-75 bg-dark">
          ...
          <a class="btn btn-primary" href="../balance.jsp"  role="button">Check Balance</a>
        </div>
      </div>
      <div class="carousel-item">
        <img
        ...
        <div class="carousel-caption d-none d-md-block opacity-75 bg-dark">
          ...
          <a class="btn btn-primary" href="../withdramMoney.jsp" role="button">Withdraw Money</a>
        </div>
      </div>
    </div>
  ...
  <div class="container align-middle ">
    ...
    <div class="row featurette rounded-bottom-1 bg-body-secondary">
      <div class="col-md-7">
        ...
        <a class="btn btn-primary" href="../transaction.jsp"  role="button">Send Money <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
    ...
    <div class="row featurette rounded-bottom-1 bg-body-secondary">
      <div class="col-md-6 order-md-2">
        ...
        <p class="lead">Another featurette? Of course. More placeholder content here to give you an idea of how this
          ...
          <a class="btn btn-primary" href="../balance.jsp"  role="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
    ...
    <div class="row featurette rounded-bottom-1 bg-body-secondary">
      <div class="col-md-7">
        ...
        <a class="btn btn-primary" href="../withdramMoney.jsp" role="button">Withdram Money<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
            <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8"/>
          </svg></a>
      </div>
      <div class="col-md-5">
