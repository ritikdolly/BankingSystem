...
<head>
    ...
    <title>Star Diamond Home Loan |Features</title>
                    ...
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu custom-dropdown">
                                ...
                                <li><a class="dropdown-item" href="starTopUpLoan.jsp">STAR TOP UP LOAN</a></li>
                                <li><a class="dropdown-item" href="starSmartHomeLoan.jsp">Star Smart Home Loan</a></li>
                                <li><a class="dropdown-item" href="starTopUpLoan.jsp">Star Pravasi Home Loan</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
    ...
    <div class="container userContainer">
                ...
                <div class="row">
                    <div
                        ...
                        <h1 id="banner-long-title" class="primary-text-color font-weight-bold text-uppercase">Star
                            Diamond Home Loan</h1>
                        <p class="mb-lg-5 mb-sm-3 text-justify">Joy of owing a home without burden
                        ...
                        <picture data-fileentryid="24947718">
                            ...
                            <picture data-fileentryid="24947718">
                                ...
                                <img class="img-fluid boder-img product-detail-banner" alt="Home Loans"
                                    ...
                                    src="https://bankofindia.co.in/documents/20121/24947716/StarDiamondHomeLoan.webp/a2d4ea16-7fba-fb85-e380-24bf536b0c1a?t=1723780899012">
                            </picture>
                        </picture>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card border-0">
                    <div class="card-body pb-0 pt-0 px-0">
                        <h2 class="tabheadingmand tabseo tab-contet-botom-headin my-3"></h2>
                        <hr class="selectedtabhr">
                        <div class="col-md-12 my-3">
                            <h3 class="tab-contet-botom-headin"></h3>
                            <p class="normal-text my-3 text-justify">Make your dream of owning a premium property come
                                true with seamless finance from Star Diamond Home Loan. Get the best online home loan
                                for buying luxurious residential properties in a prime metropolitan city with minimal
                                processing and attractive interest rates.</p>
                        </div>
                        <div class="col-md-12 my-3">
                            <h3 class="tab-contet-botom-headin"></h3>
                            <p class="normal-text my-3 text-justify">Star Diamond Home Loan is designed to help you get
                                a specialised finance for buying properties that offer ultimate luxury and prestige to
                                its owners. With hassle-free processes, low interest rates, and the legacy of the Bank
                                of India, your journey towards buying a dream luxury home becomes easier.</p>
                        </div>
                        <div class="col-md-12 my-3">
                            <h3 class="tab-contet-botom-headin"></h3>
                            <p class="normal-text my-3 text-justify">It’s time for you to live life to fullest by
                                achieving your dream of owning a home that matches your prestige. Experience the
                                simplicity and convenience of our online application process. Apply for Star Diamond
                                Home Loan online today and step into the world of luxury living.</p>
                        </div>
                        <div class="row">
                            <div class="row">
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                    ...
                    <div class="col-12">
                        <div class="card border-0">
                            <div class="card-body pb-0 pt-0 px-0">
                                <h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">Star Diamond Home Loan -
                                    FEATURES</h4>
                                <hr class="selectedtabhr" style="display: block;">
                                <div class="col-md-12 my-3">
                                    <h3 class="tab-contet-botom-headin"></h3>
                                    <ul class="pl-3 normal-text my-3 List-eligiblity">
                                        <li class="my-2">Quantum of Loan – Above 7.5 Cr</li>
                                        <li class="my-2">Maximum repayment tenure up to 360 months</li>
                                        <li class="my-2">Holiday/Moratorium period up to 36 months</li>
                                        <li class="my-2">Smart Home Loan (OD facility) for entire limit/outstanding
                                            balance @ROI of Home Loan</li>
                                        <li class="my-2">Takeover/Balance Transfer facility with additional Loan amount
                                        </li>
                                        <li class="my-2">Instant Top Up Loan Available</li>
                                        <li class="my-2">Loan facility for addition/extension/renovation of existing
                                            property</li>
                                        <li class="my-2">Insurance premium considered under Project Cost (treated as
                                            Home Loan component)</li>
                            ...
                            <div class="card-body pb-0 pt-0 px-0">
                                ...
                                <div class="col-md-12 my-3">
                                    ...
                                    <ul class="pl-3 normal-text my-3 List-eligiblity">
                                        ...
                                        <li class="my-2">HNI Individuals: Salaried/Self-employed/Professionals</li>
                                        <li class="my-2">Non-individuals: Group/Association of Individuals, HUF,
                                            Corporates</li>
                                        <li class="my-2">Minimum average gross income of Rs. 1 Cr &amp; Above during
                                            last 3 Years</li>
                                        <li class="my-2">Trust is not eligible under the scheme</li>
                                        <li class="my-2">Age: Minimum 18 years to maximum age 70 years at the time of
                                            final repayment</li>
                                    </ul>
                                </div>
                                <div class="row">
                        ...
                        <div class="card border-0">
                            <div class="card-body pb-0 pt-0 px-0">
                                ...
                                <div class="col-md-12 my-3">
                                    ...
                                    <h5 class="list-heading my-3">Rate Of Interest(ROI)</h5>
                                    <ul class="pl-3 normal-text my-3 List-eligiblity">
                                        <li class="my-2">Starting from 8.40%</li>
                                ...
                                <div class="col-md-12 my-3">
                                    <h5 class="tab-contet-botom-headin"></h5>
                                    <h5 class="list-heading my-3">Charges</h5>
                                    <ul class="pl-3 normal-text my-3 List-eligiblity">
                                        <li class="my-2">PPC For Individuals: One time @0.25% of Loan amount: Min. Rs.
                                            1500/- to Max. Rs. 20000/-</li>
                                        <li class="my-2">PPC For Other than individuals: One time @0.50% of Loan amount:
                                            Min. Rs. 3000/- to Max. Rs. 40000/-</li>
                                    </ul>
                                </div>
                                <div class="row">
                                    <div class="row">
                                ...
                                <div class="col-md-12 my-3">
                                    ...
                                    <ul class="pl-3 normal-text my-3 List-eligiblity">
                                        ...
                                        <li class="my-2">Proof of Income (any one): <br>For salaried: Latest 6 Month
                                            ...
                                            ITR with Computation of Income/Profit &amp; Loss Account/Balance\
            ...
            <div class="row">
                ...
                <div class="col mb-3">
                    <div class="card userCard" style="width:18rem; height:364.26px;">
                        <img src="https://bankofindia.co.in/documents/20121/24947716/STARTOPUPLOAN.webp/43e89941-f004-a7d6-d32f-1e4077e77e49?t=1723780971602"
                            class="card-img-top" alt="...">
                        <div class="card-body d-flex justify-content-between flex-column">
                            <h5 class="card-title">STAR TOP UP LOAN</h5>
                            <p class="card-text">Easily top up your Existing loan</p>
                            <a href="starTopUpLoan.jsp" class="icon-link gap-1 icon-link-hover stretched-link">
                                Learn More <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd"
                                        d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8" />
