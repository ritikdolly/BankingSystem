...
<head>
    ...
    <title>Star Pravasi Home Loan |Features</title>
            ...
            <div class="container">
                <div class="row">
                    <div
                        ...
                        <h1 id="banner-long-title" class="primary-text-color font-weight-bold text-uppercase">Star Pravasi Home Loan</h1>
                        <p class="mb-lg-5 mb-sm-3 text-justify">Build your dream home with our affordable bank finance.</p>
                    </div>
                        ...
                        <picture data-fileentryid="24947718">
                            ...
                            <picture data-fileentryid="24947718">
                                ...
                                <img class="img-fluid boder-img product-detail-banner" alt="Home Loans"
                                    ...
                                    src="https://bankofindia.co.in/documents/20121/24947716/STARPRAVASIHOMELOAN.webp/f2cacc15-89c4-cf53-8573-5df7831fe71a?t=1723780947813">
                            </picture>
                        </picture>
                    </div>
                </div>
            ...
            <div class="tab-content" id="myTabContent">
                    ...
                    <div class="col-12">
                        <div class="card border-0">
                         <div class="card-body pb-0 pt-0 px-0">
                          <h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">Star Pravasi Home Loan - FEATURES</h4>
                          ...
                          <div class="col-md-12 my-3">
                           ...
                           <ul class="pl-3 normal-text my-3 List-eligiblity">
                            ...
                            <li class="my-2">EMI starts at Rs.776/- per lakh</li>
                            ...
                            <li class="my-2">Smart Home Loan (OD facility) for entire limit/outstanding balance @0.50 above ROI of Home Loan</li>
                ...
                <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab"
                    ...
                    <div class="col-12">
                        <div class="card border-0">
                         <div class="card-body pb-0 pt-0 px-0">
                          <h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">Star Pravasi Home Loan - ELIGIBILITY</h4>
                          <hr class="selectedtabhr" style="display: block;">
                          <div class="col-md-12 my-3">
                           <h5 class="tab-contet-botom-headin"></h5>
                           <ul class="pl-3 normal-text my-3 List-eligiblity">
                            <li class="my-2">NRI/PIO are eligible</li>
                            <li class="my-2">Indian Citizen working in merchant navy having NRI status</li>
                            <li class="my-2">Indian citizens working abroad on assignment with National/International government agencies</li>
                ...
                <div class="tab-pane fade" id="contact-tab-pane" role="tabpanel" aria-labelledby="contact-tab"
                    ...
                    <div class="col-12">
                        <div class="card border-0">
                         <div class="card-body pb-0 pt-0 px-0">
                          <h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">Star Pravasi Home Loan - RATE OF INTEREST &amp; CHARGES</h4>
                          <hr class="selectedtabhr" style="display: block;">
                          <div class="col-md-12 my-3">
                           <h5 class="tab-contet-botom-headin"></h5>
                           <ul class="pl-3 normal-text my-3 List-eligiblity">
                ...
                <div class="tab-pane fade" id="doc-tab-pane" role="tabpanel" aria-labelledby="doc-tab"
                    ...
                    <div class="col-12">
                        <div class="card border-0">
                         <div class="card-body pb-0 pt-0 px-0">
                          <h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">Star Pravasi Home Loan - DOCUMENTS</h4>
                          <hr class="selectedtabhr" style="display: block;">
                          <div class="col-md-12 my-3">
                           <h5 class="tab-contet-botom-headin">For Individuals</h5>
                           <ul class="pl-3 normal-text my-3 List-eligiblity">
                            <li class="my-2">Passport with VISA printed on it</li>
                            <li class="my-2">Work permit</li>
                            <li class="my-2">Copy of PAN</li>
                            <li class="my-2">ID card issued by employer</li>
                            <li class="my-2">Proof of Address in India</li>
                            <li class="my-2">Proof of Address in Foreign</li>
                            <li class="my-2">Proof of Address in Employer with contact details</li>
                            <li class="my-2">Latest Salary slip in original</li>
                            <li class="my-2">Annual Income Tax Return filed as per rules applicable in the country where he resides for last 2 years</li>
                           </ul>
                          </div>
                          <div class="col-md-12 my-3">
                           ...
                           <ul class="pl-3 normal-text my-3 List-eligiblity">
                            ...
                            <li class="my-2">Proof of Address in India</li>
                            <li class="my-2">Proof of Address in Foreign</li>
                            <li class="my-2">Membership of professional organization</li>
                            <li class="my-2">Government or local body permission or license to engage in business activity</li>
                            <li class="my-2">Income Proof (Based on Audited Financial)</li>
                            <li class="my-2">Statement/Income Proof/Return etc., as applicable to the country of present residence</li>
                           </ul>
                          </div>
                          <div class="col-md-12 my-3">
                           <h5 class="tab-contet-botom-headin"># To be attested by employer (if employer is a Bank/MNC/Govt. Body). Otherwise To be attested by Bank of India Branch /Representative Office /consulate /our foreign office /Embassy.</h5>
                          </div>
                          <div class="row">
                           <div class="row">
                            <div class="clearfix"></div>
