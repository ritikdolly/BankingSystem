...
<head>
    ...
    <title>Star Home Loan |Features</title>
                    ...
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu custom-dropdown">
                                ...
                                <li><a class="dropdown-item" href="starPravasiHomeLoan.jsp">Star Pravasi Home Loan</a></li>
                            </ul>
                            <li class="nav-item">
            ...
            <div class="container">
                <div class="row">
                    <div
                        ...
                        <h1 id="banner-long-title" class="primary-text-color font-weight-bold text-uppercase">Star Home
                            Loan</h1>
                        <p class="mb-lg-5 mb-sm-3 text-justify">Why rent when you can buy with RSGDSA
                        ...
                        <picture data-fileentryid="24947718">
                            ...
                            <picture data-fileentryid="24947718">
                                ...
                                <img class="img-fluid boder-img product-detail-banner" alt="Home Loans"
                                    ...
                                    src="https://bankofindia.co.in/documents/20121/24947716/STARHOMELOAN.webp/b19308b6-0bab-fe3b-245e-afebb547e1e7?t=1723780877818">
                            </picture>
                        </picture>
                    </div>
                </div>
        ...
        <div class="row">
                ...
                <div class="card border-0">
                    <div class="card-body pb-0 pt-0 px-0">
                        ...
                        <div class="col-md-12 my-3">
                            ...
                            <p class="normal-text my-3 text-justify">If you have a dream home in mind, we have just the
                                right finance for it. Star Home Loan offers hassle-free finance to ease up your
                                home-buying journey. With attractive home loan interest rates and minimal paperwork, we
                                make sure you get the best deal in the financial market. We offer dedicated support for
                                a seamless home loan process which further extends throughout the repayment period.</p>
                        </div>
                        <div class="col-md-12 my-3">
                            <h3 class="tab-contet-botom-headin"></h3>
                            <p class="normal-text my-3 text-justify">Whether you are a first-time homebuyer or looking
                                for sound finance to invest in residential property, rest assured that you get
                                customised finance with competitive Star Home Loan interest rates. Take your first step
                                towards the keys to your dream home by contacting us and learning everything that Star
                                Home Loan has to offer.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                    ...
                    <div class="card border-0">
                        <div class="card-body pb-0 pt-0 px-0">
                            <h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">Star Home Loan - FEATURES
                            </h4>
                            ...
                            <div class="col-md-12 my-3">
                                ...
                                <ul class="pl-3 normal-text my-3 List-eligiblity">
                                    ...
                                    <li class="my-2">EMI starts @ Rs.755/-per Lakh</li>
                                    <li class="my-2">Income of co-applicant (close relative) considered for eligibility
                                    </li>
                                    <li class="my-2">Smart Home Loan (OD facility) for entire limit/outstanding balance
                                        @ROI of Home Loan</li>
                                    <li class="my-2">For purchase of plot (house to be constructed within 5 years)</li>
                                    ...
                                    <li class="my-2">Insurance premium considered under Project Cost (treated as Home
                                        Loan component)</li>
                ...
                <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab"
                    tabindex="0">
                    <div class="card-body pb-0 pt-0 px-0">
                        <h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">Star Home Loan - ELIGIBILITY</h4>
                        <hr class="selectedtabhr" style="display: block;">
                        <div class="col-md-12 my-3">                            
                            <ul class="pl-3 normal-text my-3 List-eligiblity">
                                ...
                                <li class="my-2">Age: Minimum 18 years to maximum age 70 years at the time of final
                                    repayment</li>
                            </ul>
                        </div>
                        <div class="col-md-12 my-3">
                            ...
                            <ul class="pl-3 normal-text my-3 List-eligiblity">
                                ...
                                <li class="my-2">Proof of Address (any one): Passport/Driver Licence/Aadhar Card/ Latest
                                    Electricity Bill/Latest Telephone Bill/Latest Piped gas bill</li>
                                <li class="my-2">Proof of Income (any one): For salaried: Latest 6 Month Salary/Pay Slip
                                    and
                                    One year ITR/Form16 For Self-employed: Last 3 years ITR with Computation of
                                    Income/Profit &amp; Loss Account/Balance\ Sheet/Capital Account Statement</li>
                            </ul>
                        </div>
                        <div class="col-md-12 my-3">
                            <h5 class="tab-contet-botom-headin"></h5>
                            <h5 class="list-heading my-3">For Other than Individuals</h5>
                            <ul class="pl-3 normal-text my-3 List-eligiblity">
                ...
                <div class="tab-pane fade" id="contact-tab-pane" role="tabpanel" aria-labelledby="contact-tab"
                    ...
                    <div class="col-12">
                        <div class="card border-0">
                            <div class="card-body pb-0 pt-0 px-0">
                                <h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">Star Home Loan - INTEREST
                                    RATES &amp; CHARGES</h4>
                                <hr class="selectedtabhr" style="display: block;">
                                <div class="col-md-12 my-3">
                                    <h5 class="tab-contet-botom-headin"></h5>
