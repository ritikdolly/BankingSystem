...
<head>
    ...
    <title>Star Smart Home Loan |Features</title>
            ...
            <div class="container">
                <div class="row">
                    <div
                        ...
                        <h1 id="banner-long-title" class="primary-text-color font-weight-bold text-uppercase">Star Smart
                            Home Loan</h1>
                        <p class="mb-lg-5 mb-sm-3 text-justify">It's a smart move with Star Smart Home Loan</p>
                    </div>
                        ...
                        <picture data-fileentryid="24947718">
                            ...
                            <picture data-fileentryid="24947718">
                                ...
                                <img class="img-fluid boder-img product-detail-banner" alt="Home Loans"
                                    ...
                                    src="https://bankofindia.co.in/documents/20121/24947716/STARSMARTHOMELOAN.webp/2d0a6764-56da-a3a9-b081-04fc1731f538?t=1723780920057">
                            </picture>
                        </picture>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="tab-content" id="myTabContent">
                    ...
                    <div class="col-12">
                        <div class="card border-0">
                            <div class="card-body pb-0 pt-0 px-0">
                                <h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">Star Smart Home Loan -
                                    FEATURES</h4>
                                ...
                                <div class="col-md-12 my-3">
                                    ...
                                    <ul class="pl-3 normal-text my-3 List-eligiblity">
                                        <li class="my-2">Minimum Loan amount:</li>
                                        <li class="my-2">For Salaried: Rs. 5.00 Lacs</li>
                                        <li class="my-2">For self-employed: Rs. 10.00 Lacs</li>
                                        <li class="my-2">Maximum repayment tenure up to 360 months</li>
                                        <li class="my-2">Holiday/Moratorium period up to 36 months</li>
                                        <li class="my-2">Income of co-applicant (close relative) considered for
                                            eligibility</li>
                                        <li class="my-2">For purchase of plot (house to be constructed within 5 years)
                                        </li>
                                ...
                                <div class="col-md-12 my-3">
                                    ...
                                    <ul class="pl-3 normal-text my-3 List-eligiblity">
                                        ...
                                        <li class="my-2">Overdraft facility</li>
                                        <li class="my-2">Operation of account through Cheque book, Debit card,
                                            Net-banking/Mobile banking facility</li>
                                        <li class="my-2">No hidden charges</li>
                                        <li class="my-2">No prepayment penalty</li>
                                        <li class="my-2">Free accidental insurance coverage up to limit Rs. 5.00 Crores
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="card border-0">
                            <div class="card-body pb-0 pt-0 px-0">
                                ...
                                <div class="col-md-12 my-3">
                                    <h5 class="tab-contet-botom-headin"></h5>
                                    <ul class="pl-3 normal-text my-3 List-eligiblity">
                                        <li class="my-2">Existing SB/CD customer with average balance above Rs. 5000
                                            since last 1 year</li>
                                        <li class="my-2">New SB/CD Customers with opening balance above Rs. 5000</li>
                                        <li class="my-2">Individuals with Salary account with BOI</li>
                                        <li class="my-2">All other conditions as per Star Home Loan scheme</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="tab-pane fade" id="doc-tab-pane" role="tabpanel" aria-labelledby="doc-tab" tabindex="0">
                    <div class="card-body pb-0 pt-0 px-0">
                        <h2 class="tabheadingmand tabseo tab-contet-botom-headin my-3">Star Smart Home Loan - DOCUMENTS
                        </h2>
                        <hr class="selectedtabhr" style="display: block;">
                        <div class="col-md-12 my-3">
                            ...
                            <ul class="pl-3 normal-text my-3 List-eligiblity">
                                ...
                                <li class="my-2">Proof of Income (any one): For salaried: Latest 6 Month Salary/Pay Slip
                                    and One year ITR/Form16 For Self-employed: Last 3 years ITR with Computation of
