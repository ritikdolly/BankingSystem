...
<head>
  ...
  <title>Customer Access | Features</title>
          ...
          <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu custom-dropdown">
                <li><a class="dropdown-item" href="customerCtrls?action=startTransfer&CustId=${mainUser}">Send Money</a></li>
  ...
  <div class="container align-middle ">
    ...
    <div class="row featurette rounded-bottom-1 bg-body-secondary">
      <div class="col-md-6 order-md-2">
        ...
        <p class="lead">Another featurette? Of course. More placeholder content here to give you an idea of how this
          ...
          <a class="btn btn-primary" href="#"  role="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
    ...
    <div class="row featurette rounded-bottom-1 bg-body-secondary">
      <div class="col-md-7">
        ...
        <a class="btn btn-primary" href="#" role="button">Withdraw Money <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
            <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8"/>
          </svg></a>
      </div>
      <div class="col-md-5">
