							...
							<ul class="dropdown-menu custom-dropdown">
								<li><a class="dropdown-item"
									href="starSuvidhaExpressPersonalLoan.jsp">Star suvidha
										express Loan</a></li>
								<li><a class="dropdown-item" href="starPersonalLoan.jsp">Star
										Personal Loan</a></li>
				...
				<div class="row">
					<div
						...
						<h1 id="banner-long-title"
							class=" font-weight-bold text-uppercase">STAR MITRA PERSONAL
							LOAN</h1>
						...
						<div class="card border-0">
							<div class="card-body pb-0 pt-0 px-0">
								<h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">STAR
									MITRA PERSONAL LOAN - FEATURES</h4>
								...
								<div class="col-md-12 my-3">
									...
									<ul class="pl-3 normal-text my-3 List-eligiblity">
										...
										<li class="my-2">Maximum quantum up 15 times the net
											monthly salary or 100% of net annual income for self-employed</li>
								...
								<div class="col-md-12 my-3">
									...
									<ul class="pl-3 normal-text my-3 List-eligiblity">
										...
										<li class="my-2">To purchase durable and sophisticated
											aids/ appliances to promote their physical and social
											rehabilitation.</li>
										<li class="my-2">No Processing charges</li>
										<li class="my-2">Low rate interest starting from 10.85%
											p.a., (for DRI case 4%.)</li>
				...
				<div class="tab-pane fade" id="Eligibility-tab-pane" role="tabpanel"
					...
					<div class="col-12">
						<div class="card border-0">
							<div class="card-body pb-0 pt-0 px-0">
								<h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">STAR
									MITRA PERSONAL LOAN - ELIGIBILITY</h4>
								<hr class="selectedtabhr" style="display: block;">
								<div class="col-md-12 my-3">
									<h5 class="tab-contet-botom-headin"></h5>
									<ul class="pl-3 normal-text my-3 List-eligiblity">
										...
										<li class="my-2">Age: Maximum age 70 years at the time of
											final repayment</li>
										<li class="my-2">Maximum Loan Amount: Know Your
											Eligibility</li>
									</ul>
								</div>
							</div>
				...
				<div class="tab-pane fade" id="interest-tab-pane" role="tabpanel"
					...
					<div class="col-12">
						<div class="card border-0">
							<div class="card-body pb-0 pt-0 px-0">
								<h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">STAR
									MITRA PERSONAL LOAN - RATE OF INTEREST &amp; CHARGES</h4>
								<hr class="selectedtabhr" style="display: block;">
								<div class="col-md-12 my-3">
									<h5 class="tab-contet-botom-headin"></h5>
									<ul class="pl-3 normal-text my-3 List-eligiblity">
				...
				<div class="tab-pane fade" id="doc-tab-pane" role="tabpanel"
					...
					<div class="col-12">
						<div class="card border-0">
							<div class="card-body pb-0 pt-0 px-0">
								<h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">STAR
									MITRA PERSONAL LOAN - DOCUMENTS</h4>
								<hr class="selectedtabhr" style="display: block;">
								<div class="col-md-12 my-3">
									...
									<ul class="pl-3 normal-text my-3 List-eligiblity">
										...
										<li class="my-2">Proof of Address (any one):<br>
											Passport/Driver Licence/Aadhar Card/ Latest Electricity
											Bill/Latest Telephone Bill/Latest Piped gas bill
										</li>
										<li class="my-2">Proof of Income (any one):<br> For
											salaried: Latest 6 Month Salary/Pay Slip and One year
											ITR/Form16 For Self-employed: Last 3 years ITR with CA
											certified Computation of Income/Profit &amp; Loss
											Account/Balance Sheet/Capital Account Statement
										</li>
										<li class="my-2">Doctor’s certificate regarding the
											extent of handicap and need of equipment.</li>
									</ul>
								</div>
							</div>
						</div>
