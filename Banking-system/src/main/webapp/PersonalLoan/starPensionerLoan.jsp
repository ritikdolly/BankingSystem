				...
				<div class="row">
					<div
						...
						<h1 id="banner-long-title"
							...
							Pensioner Loan</h1>
						<p class="mb-lg-5 mb-sm-3 text-justify">Making it simple for
							you</p>
					</div>
					<div
							...
							<div class="card-body pb-0 pt-0 px-0">
								...
								<div class="col-md-12 my-3">
									...
									<ul class="pl-3 normal-text my-3 List-eligiblity">
										...
										<li class="my-2">Maximum quantum upto 20 times for
											secured and 15 times for clean loan of the net monthly
											pension</li>
										<li class="my-2">Maximum repayment tenure up to 60 months</li>
										<li class="my-2">Quick disposal of the loan (Very less
											turnaround time)</li>
										<li class="my-2">Nil processing charges for senior
											citizen</li>
								...
								<div class="col-md-12 my-3">
									...
									<ul class="pl-3 normal-text my-3 List-eligiblity">
										<li class="my-2">No processing charges for senior
											citizens</li>
				...
				<div class="tab-pane fade" id="Eligibility-tab-pane" role="tabpanel"
					...
					<div class="col-12">
						<div class="card border-0">
							<div class="card-body pb-0 pt-0 px-0">
								<h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">STAR
									PENSIONER LOAN - ELIGIBILITY</h4>
								<hr class="selectedtabhr" style="display: block;">
								<div class="col-md-12 my-3">
									<h5 class="tab-contet-botom-headin"></h5>
									<ul class="pl-3 normal-text my-3 List-eligiblity">
										<li class="my-2">Individuals: Pensioners drawing pension
											through Bank Branch</li>
				...
				<div class="tab-pane fade" id="interest-tab-pane" role="tabpanel"
					...
					<div class="col-12">
						<div class="card border-0">
							<div class="card-body pb-0 pt-0 px-0">
								<h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">STAR
									PENSIONER LOAN - RATES OF INTEREST &amp; CHARGES</h4>
								<hr class="selectedtabhr" style="display: block;">
								<div class="col-md-12 my-3">
								...
								<div class="col-md-12 my-3">
									...
									<ul class="pl-3 normal-text my-3 List-eligiblity">
										<li class="my-2">No processing charges for senior
											citizens</li>
										<li class="my-2">For others — one time @ 2% of loan
											amount Min. Rs.500 and Max. Rs.2,000/-.</li>
									</ul>
								</div>
							</div>
						</div>
