						...
						<div class="card border-0">
							<div class="card-body pb-0 pt-0 px-0">
								<h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">STAR
									SUVIDHA EXPRESS PERSONAL LOAN - FEATURES</h4>
								...
								<div class="col-md-12 my-3">
									...
									<ul class="pl-3 normal-text my-3 List-eligiblity">
										...
										<li>Maximum quantum up 24 times the gross monthly salary
											for salaried</li>
										<li>Maximum quantum up 36 times the gross monthly for
											existing Home Loan Customers</li>
										<li>Maximum repayment tenure up to 84 months</li>
										<li>Quick disposal of the loan (Very less turn around
											time)</li>
										<li>Clean loan facility available without pledging of any
											security</li>
				...
				<div class="tab-pane fade" id="Eligibility-tab-pane" role="tabpanel"
					...
					<div class="col-12">
						<div class="card border-0">
							<div class="card-body pb-0 pt-0 px-0">
								<h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">STAR
									SUVIDHA EXPRESS PERSONAL LOAN - ELIGIBILITY</h4>
								<hr class="selectedtabhr" style="display: block;">
								<div class="col-md-12 my-3">
									<h5 class="tab-contet-botom-headin"></h5>
									<ul class="pl-3 normal-text my-3 List-eligiblity">
										<li class="my-2">Individuals: Salaried customers having
											salary accounts with BOI</li>
										<li class="my-2">Existing salaried Home loan customers of
											BOI</li>
										<li class="my-2">Age: Maximum age 75 years at the time of
											final repayment</li>
				...
				<div class="tab-pane fade" id="interest-tab-pane" role="tabpanel"
					...
					<div class="col-12">
						<div class="card border-0">
							<div class="card-body pb-0 pt-0 px-0">
								<h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">STAR
									SUVIDHA EXPRESS PERSONAL LOAN - RATE OF INTEREST &amp; CHARGES</h4>
								<hr class="selectedtabhr" style="display: block;">
								<div class="col-md-12 my-3">
									<h5 class="tab-contet-botom-headin"></h5>
									<ul class="pl-3 normal-text my-3 List-eligiblity">
				...
				<div class="tab-pane fade" id="doc-tab-pane" role="tabpanel"
					...
					<div class="col-12">
						<div class="card border-0">
							<div class="card-body pb-0 pt-0 px-0">
								<h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">STAR
									SUVIDHA EXPRESS PERSONAL LOAN - DOCUMENTS</h4>
								<hr class="selectedtabhr" style="display: block;">
								<div class="col-md-12 my-3">
									<h5 class="tab-contet-botom-headin"></h5>
