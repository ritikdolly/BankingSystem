...
<head>
    ...
    <title>Personal Loan | features</title>
            ...
            <div class="container">
             <div class="row">
              <div class="col-lg-4 order-2  left-text order-sm-2 order-md-2 order-lg-1 pl-0 pl-mob-grid banner-left-text">
               ...
               <h1 id="banner-long-title" class="primary-text-color font-weight-bold text-uppercase">Personal Loans</h1>
               <p class="mb-lg-5 mb-sm-3 text-justify">A bouquet of products that caters all your personal needs.</p>
              </div>
              <div class="col-lg-8 order-1 order-sm-1 order-md-1 order-lg-2 pr-0 pr-mob-grid"><picture data-fileentryid="24947718">
                ...
                <picture data-fileentryid="24947718">
                 <source media="(max-width:300px)" srcset="/o/adaptive-media/image/24947718/Thumbnail-300x300/home-loans.webp?t=1723780756410">
                 <source media="(max-width:1000px) and (min-width:300px)" srcset="/o/adaptive-media/image/24947718/Preview-1000x0/home-loans.webp?t=1723780756410">
                 <img class="img-fluid boder-img product-detail-banner" alt="Personal Loans" title="Personal Loans" data-fileentryid="24947718" src="https://bankofindia.co.in/documents/20121/24946494/personal-loans.webp/e8cce4b3-eda3-3587-26c6-651d752603d9?t=1723636958333">
                </picture>
               </picture>
              </div>
             </div>
            ...
            <div class="container">
             <div class="row">
              <div class="col-12 px-0 px-mob-grid">
               <h2 class="heading mt-1 mt-md-0 mb-1">BENEFITS OF PERSONAL LOAN</h2>
               <p>Personal loans, at the very minimum, impose interest. We've carefully curated a series of personal loan products with more benefits to make your life easy. A personal loan, unlike a credit card, provides borrowers with a onetime cash payment.</p>
              </div>
             </div>
            </div>
           </section>
        ...
        <div class="row mb-2">
            <div class="col-md-6 userbox">
                <div
                    ...
                    <div class="col p-4 d-flex flex-column position-static">
                        <h3 class="mb-0">Star Personal Loan</h3>
                        <div class="mb-1 text-body-secondary">Apr 10</div>
                        <p class="card-text mb-auto">A Loan for your every need</p>
            ...
            <div class="col-md-6 userbox">
                <div
                    ...
                    <div class="col p-4 d-flex flex-column position-static">
                        <h3 class="mb-0">Star Pensioner Loan</h3>
                        <div class="mb-1 text-body-secondary">Jan 12</div>
                        <p class="card-text mb-auto">Making it simple for you</p>
        ...
        <div class="row mb-2">
            <div class="col-md-6 userbox">
                <div
                    ...
                    <div class="col p-4 d-flex flex-column position-static">
                        <h3 class="mb-0">Star Suvidha Express Personal Loan</h3>
                        <div class="mb-1 text-body-secondary">Feb 12</div>
                        <p class="card-text mb-auto">A Loan you can easily afford</p>
            ...
            <div class="col-md-6 userbox">
                <div
                    ...
                    <div class="col-auto d-none d-lg-block">
                        <!-- <svg class="bd-placeholder-img" width="200" height="250" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"></rect><text x="50%" y="50%" fill="#eceeef" dy=".3em">Thumbnail</text></svg> -->
                        <img src="https://bankofindia.co.in/documents/20121/24946494/star-rooftop-loan.webp/82bb4c2b-19da-c215-49ec-717df7b5167c?t=1723636846275"
                            width="300" height="250" alt="STAR ROOFTOP SOLAR PANEL FINANCE LOAN">
                    </div>
                    <div class="col p-4 d-flex flex-column position-static">
                        <h3 class="mb-0">STAR ROOFTOP SOLAR PANEL FINANCE LOAN</h3>
