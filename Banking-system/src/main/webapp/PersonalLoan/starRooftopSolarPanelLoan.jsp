...
<title>PM SURYA GHAR – BOI STAR ROOFTOP SOLAR PANEL FINANCE LOAN
	|Features</title>
<link
			...
			<div class="container">
				<div class="row">
					<div
						...
						<h1 style="font-size: 45px;" id="banner-long-title"
							class=" font-weight-bold text-uppercase">PM SURYA GHAR – BOI
							STAR ROOFTOP SOLAR PANEL FINANCE LOAN</h1>
						<p></p>
					</div>
					<div
			...
			<div class="tab-content" id="myTabContent">
				<div class="tab-pane fade show active" id="Feature-tab-pane"
					...
					<div class="card-body pb-0 pt-0 px-0">
						<h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">PM
							SURYA GHAR – BOI STAR ROOFTOP SOLAR PANEL FINANCE LOAN - FEAtures</h4>
						...
						<div class="col-md-12 my-3">
							...
							<ul class="pl-3 normal-text my-3 List-eligiblity">
								<li class="my-2">Margin – For Individual – 5% For Housing
									Society – 10%</li>
								<li class="my-2">Maximum repayment tenure up to 120 months</li>
								<li class="my-2">Quick disposal of the loan (Very less turn
									around time)</li>
						...
						<div class="col-md-12 my-3">
							...
							<ul class="pl-3 normal-text my-3 List-eligiblity">
								...
								<li class="my-2">Maximum limit -- For Individual - Rs.10.00
									lakh and For Housing Society – Rs.100.00 lakhs</li>
								<li class="my-2">Quantum -- Upto 3 KW – Rs.2.00 lakhs and
									Above 3 KW to 10 KW – Rs.10.00 lakhs</li>
				...
				<div class="tab-pane fade" id="Eligibility-tab-pane" role="tabpanel"
					...
					<div class="col-12">
						<div class="card border-0">
							<div class="card-body pb-0 pt-0 px-0">
								<h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">PM
									SURYA GHAR – BOI STAR ROOFTOP SOLAR PANEL FINANCE LOAN -
									ELIGIBILITY</h4>
								<hr class="selectedtabhr" style="display: block;">
								<div class="col-md-12 my-3">
									<h5 class="tab-contet-botom-headin"></h5>
									<ul class="pl-3 normal-text my-3 List-eligiblity">
										<li class="my-2">Individuals/Registered group housing
											societies/residential welfare associations</li>
										<li class="my-2">Borrower/co-borrower should be owner of
											the house</li>
										<li class="my-2">Age: For Individual - Maximum 70 years
											at the time of final repayment</li>
									</ul>
								</div>
							</div>
						</div>
				...
				<div class="tab-pane fade" id="interest-tab-pane" role="tabpanel"
					...
					<div class="col-12">
						<div class="card border-0">
							<div class="card-body pb-0 pt-0 px-0">
								<h4 class="tabheadingmand tabseo tab-contet-botom-headin my-3">PM
									SURYA GHAR – BOI STAR ROOFTOP SOLAR PANEL FINANCE LOAN - RATE
									OF INTEREST &amp; CHARGES</h4>
								<hr class="selectedtabhr" style="display: block;">
								<div class="col-md-12 my-3">
									<h5 class="tab-contet-botom-headin"></h5>
									<ul class="pl-3 normal-text my-3 List-eligiblity">
										<li class="my-2">Rate of Interest starting from @7.10%
											p.a.</li>
						...
						<div class="card border-0">
							<div class="card-body pb-0 pt-0 px-0">
								...
								<div class="col-md-12 my-3">
									...
									<ul class="pl-3 normal-text my-3 List-eligiblity">
										<li class="my-2">Proof of identity (any one):
											PAN/Passport/Driver Licence/Voter ID</li>
										<li class="my-2">Proof of Address (any one):
											Passport/Driver Licence/Aadhar Card/ Latest Electricity
											Bill/Latest Telephone Bill/Latest Piped gas bill</li>
										<li class="my-2">Proof of Income (any one): Latest 6
											Month Salary/Pay Slip and One year ITR/Form16</li>
									</ul>
								</div>
							</div>
						</div>
